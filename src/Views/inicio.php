      ...
      <div class="carousel-item active">
        ...
        <div class="container">
          <div class="carousel-caption d-flex flex-column">
            ...
            <h2 class="mainSubtitle text-center font-bold shadow-text">Participa en proyectos de investigación científica y tecnológica</h1>
...
<section class="seccion-contenedor">
  ...
  <div class="seccion-lista">
    ...
    <div class="seccion-texto-separador"></div>
    <a href="?option=26" class="seccion-lista-item">
