  ...
  <div class="col-lg-6 col-12 p-2 shadow-sm">
    ...
    <div class="col-lg-6 col-12 p-4">
      <div class="d-flex justify-content-center align-items-center w-100 h-100">
        <div class="row g-0">
          <div class="col-12">
            <h2 class="sectionTitle text-center font-bold m-3">Departamento de Doctorado en Ciencias en Alimentos-Bioquímica</h2>
            <div class="sectionSeparator"></div>
          </div>
          <div class="col-12" style="text-align: center;">
            <p style="text-align: justify;">
            Los programas educativos de Doctorado en Ciencias en Alimentos, Ingeniería Bioquímica y Posgrados de la UNIDA 
            (Unidad de Investigación y Desarrollo de Alimentos) pertenecen al departamento de Doctorado en Ciencias en Alimentos 
        ...
        <div class="row g-0">
          <div class="col-12">
            ...
            <h4 class="text-center fw-bold fs-3">
              <?php
              if ($jefeDepartamento) {
                echo $jefeDepartamento->nombrePuesto . " de Doctorado en Ciencias en Alimentos-Bioquímica";
              }
              ?>
            </h4>
          </div>
...
<section class="darkSection bg-dark p-2 px-4">
    <div class="row mb-4 px-2 g-0">
        <div class="darkSection bg-dark">
            ...
            El departamento de Doctorado en Ciencias en Alimentos-Bioquímica cuenta con diversos laboratorios en donde los estudiantes 
                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-4 px-2">
                        <a href="#!" data-bs-toggle="modal" data-bs-target="#modalImage3" style="text-decoration: none;">
                            ...
                            <p class="text-center shadow-text" style="color: white;">Laboratorio de Doctorado en Ciencias en Alimentos</p>
                        </a>
...
<div tabindex="-1" aria-labelledby="modalImage3" aria-hidden="true" class="modal fade" id="modalImage3">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content bg-transparent text-white text-center">
            ...
            <p>Laboratorio de Doctorado en Ciencias en Alimentos</p>
        </div>
    </div>
</div>
